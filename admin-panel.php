...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> General Hospital</h2></br>
      <h3 align ="center"> Invoice </h3>
      

  ';
  $content .= '<div style="border: 1px solid black; padding: 10px;">';
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> General Hospital </a>
